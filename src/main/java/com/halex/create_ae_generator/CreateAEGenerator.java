...
public class CreateAEGenerator {
    ...
    private void setupClient(final FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            BlockEntityRenderers.register(BlockEntityRegistry.KINETIC_ACCEPTOR.get(), KineticAcceptorRenderer::new);
            CreateAEGenerator.LOGGER.info("KineticAcceptorRenderer explicitly registered on client setup.");
        });
    }
